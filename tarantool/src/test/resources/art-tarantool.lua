do
    local _ENV = _ENV
    package.preload["art.router.api"] = function(...)
        local arg = _G.arg;
        local api = {
            space = {
                ...
                list = function()
                    ...
                    for _, v in pairs(box.space._space:select()) do
                        if not (string.startswith(v[3], '_')) then
            ...
            select = function(space, request, index, iter, stream)
                ...
                if mappingResponse[1] == nil then
                    return {}
                end

                for _, mapping_entry in pairs(mappingResponse) do
                    if not (get_requests[mapping_entry.bucket_id]) then
                        get_requests[mapping_entry.bucket_id] = {}
                    end
                    request_entry = {}
                ...
                for bucket_id, batch_req in pairs(get_requests) do
                    ...
                    if (response) then
                        for _, v in pairs(response) do
                            table.insert(result, art.core.removeBucket(space, v))
                        end
                    end
                end
...
do
    local _ENV = _ENV
    package.preload["art.router.config"] = function(...)
        local arg = _G.arg;
        local config = {
            mapping = {
                batchesPerTime = 100,
...
do
    local _ENV = _ENV
    package.preload["art.router"] = function(...)
        local arg = _G.arg;
        art = {
...
do
    local _ENV = _ENV
    package.preload["art.router.transaction"] = function(...)
        local arg = _G.arg;
        ...
        local transaction = {
            execute = function(transaction, bucket_id)
                ...
                if not (art.transaction.isSafe(transaction)) then
                    return false, 'Transaction contains unsafe operations for sharded cluster'
                end
                ...
                if response[1] then
                    art.transaction.removeBuckets(transaction, response)
                end
                return response
            end,
            ...
            isSafe = function(transaction)
                for _, operation in pairs(transaction) do
                    if (string.startswith(operation[1], 'art.api.space')) then
                        return false
                    end
                    if (operation[1] == 'art.api.select') then
                        return false
                    end
                end
                return true
...
do
    local _ENV = _ENV
    package.preload["art.storage.constants"] = function(...)
        local arg = _G.arg;
        local stream = {
            filters = {
                filterEquals = 1,
...
do
    local _ENV = _ENV
    package.preload["art.storage.deep-equal"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["art.storage.index"] = function(...)
        local arg = _G.arg;
        local index = {
...
do
    local _ENV = _ENV
    package.preload["art.storage.index-multiple-transformer"] = function(...)
        local arg = _G.arg;
        local transformer = {
...
do
    local _ENV = _ENV
    package.preload["art.storage.index-single-transformer"] = function(...)
        local arg = _G.arg;
        local transformer = {
...
do
    local _ENV = _ENV
    package.preload["art.storage"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["art.storage.schema"] = function(...)
        local arg = _G.arg;
        local schema = {
...
do
    local _ENV = _ENV
    package.preload["art.storage.space"] = function(...)
        local arg = _G.arg;
        stream = require("art.storage.stream")
...
do
    local _ENV = _ENV
    package.preload["art.storage.space-multiple-transformer"] = function(...)
        local arg = _G.arg;
        local transformer = {
...
do
    local _ENV = _ENV
    package.preload["art.storage.space-single-transformer"] = function(...)
        local arg = _G.arg;
        local transformer = {
            delete = function(space, key)
...
do
    local _ENV = _ENV
    package.preload["art.storage.stream"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["art.storage.stream-filter"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["art.storage.stream-mapper"] = function(...)
        local arg = _G.arg;
        local constants = require("art.storage.constants").stream
        local functional = require('fun')
...
do
    local _ENV = _ENV
    package.preload["art.storage.subscription"] = function(...)
        local arg = _G.arg;
        local subscription = {
...
do
    local _ENV = _ENV
    package.preload["vshard.cfg"] = function(...)
        local arg = _G.arg;
        -- vshard.cfg
...
do
    local _ENV = _ENV
    package.preload["vshard.consts"] = function(...)
        local arg = _G.arg;
        return {
            -- Bucket FSM
            BUCKET = {
...
do
    local _ENV = _ENV
    package.preload["vshard.error"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["vshard.hash"] = function(...)
        local arg = _G.arg;
        -- hash.lua
...
do
    local _ENV = _ENV
    package.preload["vshard.heap"] = function(...)
        local arg = _G.arg;
...
do
    local _ENV = _ENV
    package.preload["vshard.lua_gc"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.registry"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.replicaset"] = function(...)
        local arg = _G.arg;
        -- vshard.replicaset
        ...
        local function replica_call(replica, func, args, opts)
            ...
            local conn = replica.conn
            local net_status, storage_status, retval, error_object = pcall(conn.call, conn, func, args, opts)
        ...
        local function replicaset_master_call(replicaset, func, args, opts)
            ...
            local net_status, storage_status, retval, error_object = replica_call(master, func, args, opts)
        ...
        local function replicaset_template_multicallro(prefer_replica, balance)
            ...
            return function(replicaset, func, args, opts)
                ...
                while not net_status and timeout > 0 do
                    ...
                    net_status, storage_status, retval, err = replica_call(replica, func, args, opts)
                    now = fiber_clock()
            ...
            while not is_balance_found do
                ...
                for _, replicaset in pairs(replicasets) do
                    if not replicaset.ignore_disbalance then
                        replicaset.etalon_bucket_count = math.ceil(replicaset.weight * bucket_per_weight)
...
do
    local _ENV = _ENV
    package.preload["vshard.rlist"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.router"] = function(...)
        local arg = _G.arg;
        local log = require('log')
        local lfiber = require('fiber')
            ...
            discovery_f = function(router)
                ...
                while module_version == M.module_version do
                    ...
                    for rs_uuid, iter in pairs(iterators) do
                        ...
                        local future, err = replicaset:callro('vshard.storage.buckets_discovery', iter.args,
                                opts)
                        if not future then
                    ...
                    repeat
                        unknown_bucket_count = router.total_bucket_count - router.known_bucket_count
            ...
            discovery_f = function(router)
                ...
                while module_version == M.module_version do
                    ...
                    for rs_uuid, replicaset in pairs(router.replicasets) do
                        local active_buckets, err = replicaset:callro('vshard.storage.buckets_discovery', {},
                                { timeout = 2 })
                        while M.errinj.ERRINJ_LONG_DISCOVERY do
                            M.errinj.ERRINJ_LONG_DISCOVERY = 'waiting'
                            lfiber.sleep(0.01)
        ...
        local function router_call_impl(router, bucket_id, mode, prefer_replica,
            ...
            repeat
                ...
                if replicaset then
                    ...
                    local storage_call_status, call_status, call_error = replicaset[call](replicaset, 'vshard.storage.call',
        ...
        local function failover_ping_round(router)
            for _, replicaset in pairs(router.replicasets) do
                ...
                if replica ~= nil and replica.conn ~= nil and
                    ...
                    if not replica.conn:ping({ timeout = router.failover_ping_timeout }) then
        ...
        local function cluster_bootstrap(router, opts)
            ...
            for uuid, replicaset in pairs(router.replicasets) do
                if replicaset.etalon_bucket_count > 0 then
                    ok, err = replicaset:callrw('vshard.storage.bucket_force_create',
        ...
        local function router_info(router)
            ...
            for rs_uuid, replicaset in pairs(router.replicasets) do
                ...
                -- Build master info.
                local info, color = replicaset_instance_info(replicaset, 'master', state.alerts,
        ...
        module.internal = M
        module.module_version = function()
...
do
    local _ENV = _ENV
    package.preload["vshard.storage"] = function(...)
        local arg = _G.arg;
        local log = require('log')
        local luri = require('uri')
        local lfiber = require('fiber')
        ...
        local function bucket_guard_xc(bucket_generation, bucket_id, status)
            if bucket_generation ~= M.bucket_generation then
                ...
                if not ok or (not b and status) or (b and b.status ~= status) then
                    local msg = string.format("bucket status is changed, was %s, became %s",
        ...
        local function recovery_step_by_type(type)
            ...
            for _, bucket in _bucket.index.status:pairs(type) do
                ...
                local remote_bucket, err = destination:callrw('vshard.storage.bucket_stat', { bucket_id })
        ...
        local function local_on_master_enable()
            ...
            M.collect_bucket_garbage_fiber = util.reloadable_fiber_create('vshard.gc', M, 'gc_bucket_f')
            M.recovery_fiber = util.reloadable_fiber_create('vshard.recovery', M, 'recovery_f')
        ...
        local function gc_bucket_in_space_xc(space, bucket_id, status)
            ...
            for _, tuple in bucket_index:pairs({ bucket_id }) do
                ...
                if limit == 0 then
                    box.commit()
                    bucket_generation = bucket_guard_xc(bucket_generation, bucket_id, status)
                    goto restart
                end
            end
            box.commit()
        ...
        local function rebalancer_calculate_metrics(replicasets)
            ...
            for uuid, replicaset in pairs(replicasets) do
                ...
                if replicaset.etalon_bucket_count ~= 0 then
                    local disbalance = math.abs(needed) / replicaset.etalon_bucket_count * 100
        ...
        local function rebalancer_download_states()
            ...
            for uuid, replicaset in pairs(M.replicasets) do
                local state = replicaset:callrw('vshard.storage.rebalancer_request_state', {})
                if state == nil then
                    return
                end
        ...
        local function rebalancer_f()
            ...
            while module_version == M.module_version do
                ...
                local status, replicasets, total_bucket_active_count = pcall(rebalancer_download_states)
                if M.module_version ~= module_version then
                    return
                end
                ...
                local max_disbalance, max_disbalance_uuid = rebalancer_calculate_metrics(replicasets)
                ...
                for src_uuid, src_routes in pairs(routes) do
                    ...
                    local status, err = rs:callrw('vshard.storage.rebalancer_apply_routes',
                            { src_routes })
                    if not status then
        ...
        local function storage_cfg(cfg, this_replica_uuid, is_reload)
            ...
            M.rebalancer_disbalance_threshold = vshard_cfg.rebalancer_disbalance_threshold
            ...
            if min_master == this_replica then
                if not M.rebalancer_fiber then
                    M.rebalancer_fiber = util.reloadable_fiber_create('vshard.rebalancer', M,
                            'rebalancer_f')
                else
        ...
        local function storage_buckets_info(bucket_id)
            ...
            for _, bucket in box.space._bucket:pairs({ bucket_id }) do
                ...
                if ref then
                    ...
                    if ref.ro_lock then
                        desc.ro_lock = ref.ro_lock
                    end
                    if ref.rw_lock then
                        desc.rw_lock = ref.rw_lock
                    end
                end
        ...
        return {
            ...
            cfg = function(cfg, uuid)
                return storage_cfg(cfg, uuid, false)
            end,
...
do
    local _ENV = _ENV
    package.preload["vshard.storage.ref"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.storage.reload_evolution"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.storage.sched"] = function(...)
        local arg = _G.arg;
        --
...
do
    local _ENV = _ENV
    package.preload["vshard.util"] = function(...)
        local arg = _G.arg;
        -- vshard.util
        local log = require('log')
        local fiber = require('fiber')
        ...
        local function version_is_at_least(major_need, middle_need, minor_need)
            if major > major_need then
                return true
            end
            if major < major_need then
                return false
            end
            if middle > middle_need then
                return true
            end
            if middle < middle_need then
                return false
