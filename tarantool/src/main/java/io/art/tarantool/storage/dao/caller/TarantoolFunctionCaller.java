...
package io.art.tarantool.storage.dao.caller;
...
public final class TarantoolFunctionCaller {
    ...
    private static void logFunctionCall(String functionName, Collection<?> arguments, String callingState) {
        ...
        logger(TarantoolFunctionCaller.class).trace(format(callingState, functionName, arguments));
    }
    ...
    private static void logException(String functionName, Throwable throwable) {
        ...
        logger(TarantoolFunctionCaller.class).error(format(FAILED_FUNCTION, functionName), throwable);
    }
}
