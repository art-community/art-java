...
public class TarantoolReactiveShardedSpaceService<KeyType, ModelType> implements ReactiveSpaceService<KeyType, ModelType> {
    ...
    public TarantoolReactiveShardedSpaceService(MetaType<KeyType> keyMeta, MetaClass<ModelType> spaceMeta, TarantoolClientRegistry clients) {
