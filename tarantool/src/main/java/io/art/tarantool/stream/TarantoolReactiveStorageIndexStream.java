...
public class TarantoolReactiveStorageIndexStream<SpaceType> extends ReactiveSpaceStream<SpaceType> {
    ...
    @Builder
    public TarantoolReactiveStorageIndexStream(MetaType<SpaceType> spaceType,
