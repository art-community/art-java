...
public final class TarantoolConnector {
    ...
    private static String[] getInstanceAddress(String instanceId) {
        return new String[] {getTarantoolConfiguration(instanceId, tarantoolModule().configuration().getTarantoolConfigurations()).getConnectionAddress()};
    }
    ...
    private static TarantoolClientConfig getClientConfig(TarantoolConnectionConfiguration connectionConfiguration) {
        ...
        config.initTimeoutMillis = tarantoolModule().configuration().getConnectionTimeoutMillis();
