...
public interface Indexes<T> {
    ...
    default <F1, F2> Index2<T, F1, F2> index(MetaField<? extends MetaClass<T>, F1> field1, MetaField<? extends MetaClass<T>, F2> field2) {
        return new IndexTwoFields<>(field1, field2);
    }

    default <F1, F2, F3> Index3<T, F1, F2, F3> index(MetaField<? extends MetaClass<T>, F1> field1,
    ...
    default <F1, F2, F3, F4> Index4<T, F1, F2, F3, F4> index(MetaField<? extends MetaClass<T>, F1> field1,
                                                             MetaField<? extends MetaClass<T>, F2> field2,
                                                             MetaField<? extends MetaClass<T>, F3> field3,
    ...
    default <F1, F2, F3, F4, F5> Index5<T, F1, F2, F3, F4, F5> index(MetaField<? extends MetaClass<T>, F1> field1,
                                                                     MetaField<? extends MetaClass<T>, F2> field2,
                                                                     MetaField<? extends MetaClass<T>, F3> field3,
                                                                     MetaField<? extends MetaClass<T>, F4> field4,
