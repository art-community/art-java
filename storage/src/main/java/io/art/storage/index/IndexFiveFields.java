...
public class IndexFiveFields<C, F1, F2, F3, F4, F5> implements Index5<C, F1, F2, F3, F4, F5> {
    ...
    private final MetaField<? extends MetaClass<C>, F5> field5;

    @Override
    public List<MetaField<?, ?>> fields() {
        return linkedListOf(field1, field2, field3, field4, field5);
    }
}
