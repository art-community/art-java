...
import static ru.adk.config.TypesafeConfigLoaderConstants.DEFAULT_TYPESAFE_CONFIG_FILE_NAME;
import static ru.adk.config.TypesafeConfigLoadingExceptionMessages.CONFIG_FILE_NOT_FOUND;
