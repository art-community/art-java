...
import static ru.adk.config.GroovyConfigLoaderConstants.DEFAULT_GROOVY_CONFIG_FILE_NAME;
import static ru.adk.config.GroovyConfigLoadingExceptionMessages.CONFIG_FILE_NOT_FOUND;
