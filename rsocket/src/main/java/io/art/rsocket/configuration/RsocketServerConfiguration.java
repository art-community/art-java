...
import static io.art.server.model.ServiceMethodIdentifier.serviceMethod;
    ...
    public static RsocketServerConfiguration from(ConfigurationSource source) {
        ...
        switch (configuration.transport) {
            case TCP:
                ...
                configuration.tcpMaxFrameLength = orElse(source.getInt(SERVER_TRANSPORT_TCP_MAX_FRAME_LENGHT), FRAME_LENGTH_MASK);
                break;
            case WEB_SOCKET:
