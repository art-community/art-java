      ...
      public static final class MetaRsocketPackage extends MetaPackage {
        ...
        public static final class MetaTestPackage extends MetaPackage {
          ...
          public static final class MetaCommunicatorPackage extends MetaPackage {
            ...
            public MetaTestRsocket1Class testRsocket1Class() {
            ...
            public static final class MetaTestRsocket1Class extends MetaClass<io.art.rsocket.test.communicator.TestRsocket1> {
              private final MetaM1Method m1Method = register(new MetaM1Method());
              ...
              private MetaTestRsocket1Class() {
                super(metaType(io.art.rsocket.test.communicator.TestRsocket1.class));
              }
              ...
              @Override
              public MetaProxy proxy(Map<MetaMethod<?>, Function<Object, Object>> invocations) {
                return new MetaTestRsocket1Proxy(invocations);
              }

              public static final class MetaM1Method extends InstanceMetaMethod<io.art.rsocket.test.communicator.TestRsocket1, Void> {
                private final MetaParameter<java.lang.String> inputParameter = register(new MetaParameter<>(0, "input",metaType(java.lang.String.class)));
                ...
                @Override
                public Object invoke(io.art.rsocket.test.communicator.TestRsocket1 instance,
                    Object[] arguments) throws Throwable {
                  instance.m1((java.lang.String)(arguments[0]));
                  return null;
                }
              ...
              public static final class MetaM2Method extends InstanceMetaMethod<io.art.rsocket.test.communicator.TestRsocket1, Void> {
                private final MetaParameter<java.lang.String> inputParameter = register(new MetaParameter<>(0, "input",metaType(java.lang.String.class)));
              ...
              public static final class MetaM3Method extends InstanceMetaMethod<io.art.rsocket.test.communicator.TestRsocket1, Void> {
                private final MetaParameter<java.lang.String> inputParameter = register(new MetaParameter<>(0, "input",metaType(java.lang.String.class)));
              ...
              public class MetaTestRsocket1Proxy extends MetaProxy implements io.art.rsocket.test.communicator.TestRsocket1 {
                private final Function<Object, Object> m1Invocation;
