...
import ru.adk.http.server.body.descriptor.HttpBodyDescriptor;
import ru.adk.http.server.context.HttpRequestContext;
import ru.adk.http.server.context.HttpRequestContext.HttpRequestContextBuilder;
import ru.adk.http.server.context.MultiPartContext;
import ru.adk.http.server.context.MultiPartContext.MultiPartContextBuilder;
...
import static ru.adk.http.constants.HttpHeaders.*;
import static ru.adk.http.constants.HttpMethodType.OPTIONS;
import static ru.adk.http.constants.HttpMethodType.resolve;
import static ru.adk.http.constants.HttpMimeTypes.ALL;
import static ru.adk.http.mime.MimeType.valueOf;
import static ru.adk.http.server.HttpServerRequestHandler.executeHttpService;
import static ru.adk.http.server.constants.HttpServerExceptionMessages.*;
import static ru.adk.http.server.constants.HttpServerLoggingMessages.HTTP_REQUEST_HANDLING_EXCEPTION_MESSAGE;
import static ru.adk.http.server.constants.HttpServerLoggingMessages.HTTP_SERVLET_EVENT;
import static ru.adk.http.server.constants.HttpServerModuleConstants.EMPTY_HTTP_CONTENT_LENGTH;
import static ru.adk.http.server.constants.HttpServerModuleConstants.MULTIPART_PATTERN;
