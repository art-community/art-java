...
import ru.adk.http.server.builder.HttpMethodBuilderImplementation;
...
import static ru.adk.http.server.constants.HttpServerModuleConstants.EXECUTE_HTTP_FUNCTION;
