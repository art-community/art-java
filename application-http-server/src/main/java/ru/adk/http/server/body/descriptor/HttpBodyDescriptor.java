package ru.adk.http.server.body.descriptor;

import ru.adk.http.server.module.HttpServerModule;
import static ru.adk.core.constants.ArrayConstants.EMPTY_BYTES;
import static ru.adk.http.server.constants.HttpServerExceptionMessages.REQUEST_BODY_READING_EXCEPTION;
import static ru.adk.http.server.constants.HttpServerExceptionMessages.REQUEST_BODY_WRITING_EXCEPTION;
