package ru.adk.generator.spec.http.servicespec.operations;
...
import ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecAnnotations;
import ru.adk.generator.spec.http.servicespec.exception.HttpServiceSpecAnnotationIdentificationException;
import ru.adk.generator.spec.http.servicespec.exception.HttpServiceSpecGeneratorException;
import ru.adk.generator.spec.http.servicespec.model.*;
...
import static ru.adk.core.constants.StringConstants.NEW_LINE;
import static ru.adk.core.constants.StringConstants.TABULATION;
...
import static ru.adk.generator.common.constants.Constants.PathAndPackageConstants.BUILD;
import static ru.adk.generator.common.constants.Constants.PathAndPackageConstants.SRC_MAIN_JAVA;
import static ru.adk.generator.common.constants.Constants.SymbolsAndFormatting.METHOD_PATTERN;
import static ru.adk.generator.common.constants.Constants.SymbolsAndFormatting.STRING_PATTERN;
import static ru.adk.generator.common.constants.ExceptionConstants.*;
...
import static ru.adk.generator.spec.common.constants.SpecExceptionConstants.SpecificationGeneratorExceptions.UNABLE_TO_GENERATE_SPECIFICATION;
import static ru.adk.generator.spec.common.constants.SpecificationType.httpServiceSpec;
import static ru.adk.generator.spec.common.operations.ConstantsFieldSpecGenerator.generateMethodIdsConstantsBlock;
import static ru.adk.generator.spec.common.operations.ConstantsFieldSpecGenerator.generateServiceId;
import static ru.adk.generator.spec.common.operations.ExecuteMethodGenerator.generateExecuteMethod;
import static ru.adk.generator.spec.http.common.constants.HttpSpecConstants.Errors.INCOMPATIBLE_ANNOTATIONS;
import static ru.adk.generator.spec.http.common.operations.HttpAnnotationsChecker.getIncompatibleHttpMethodsAnnotationsForServiceMethod;
...
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecConstants.ExceptionConstants.MULTIPLE_DEFAULT_LISTEN;
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecConstants.*;
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecConstants.Methods.SERVE_METHOD;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceAuxiliaryOperations.addStaticImports;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceAuxiliaryOperations.checkHttpServiceAnnotations;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceBlockGenerator.generateHttpServiceConstant;
import java.io.File;
...
public interface HttpServiceSpecificationClassGenerator {
    ...
    static void createSpecificationClass(Class<?> service, String genPackage, String jarPathToMain)
        ...
        try {
            JavaFile.Builder javaFileBuilder = JavaFile.builder(genPackage, type)
                    .addStaticImport(ru.adk.http.server.model.HttpService.class, HTTP_SERVICE)
                    .indent(TABULATION);
    ...
    static FieldSpec generateHttpServiceBlock(Class<?> serviceClass, Map<Method, StaticImports> importsForMethods) {
        ...
        return (notGeneratedFields.size() != 0)
                ? FieldSpec.builder(ru.adk.http.server.model.HttpService.class, HTTP_SERVICE, PUBLIC, FINAL)
