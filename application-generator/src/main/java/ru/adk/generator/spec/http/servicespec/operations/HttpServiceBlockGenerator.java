...
import ru.adk.generator.spec.http.common.annotation.*;
import ru.adk.generator.spec.http.common.exception.MimeTypeDefinitionException;
import ru.adk.generator.spec.http.servicespec.annotation.FromMultipart;
...
import static ru.adk.generator.spec.http.common.constants.HttpSpecConstants.Errors.NO_HTTP_METHODS_ANNOTATION;
import static ru.adk.generator.spec.http.common.constants.HttpSpecConstants.Errors.UNABLE_TO_GENERATE_BECAUSE_OF_ANNOTATION;
...
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecAnnotations.*;
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecConstants.ExceptionConstants.*;
import static ru.adk.generator.spec.http.servicespec.constants.HttpServiceSpecConstants.Methods.*;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceAuxiliaryOperations.*;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceSpecificationClassGenerator.methodAnnotations;
import static ru.adk.generator.spec.http.servicespec.operations.HttpServiceSpecificationClassGenerator.methodIds;
