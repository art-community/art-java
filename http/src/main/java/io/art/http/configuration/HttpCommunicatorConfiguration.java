...
public class HttpCommunicatorConfiguration {
    ...
    public static HttpCommunicatorConfiguration communicatorConfiguration(HttpModuleRefresher refresher, ConfigurationSource source) {
        ...
        HttpConnectorConfiguration defaultConfiguration = connectorConfiguration();
        configuration.defaultConnectorConfiguration = let(source.getNested(DEFAULT_SECTION), nested -> connectorConfiguration(refresher, defaultConfiguration, nested), defaultConfiguration);
