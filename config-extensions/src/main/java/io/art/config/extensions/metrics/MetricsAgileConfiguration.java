...
package io.art.config.extensions.metrics;
...
import io.art.metrics.configuration.MetricModuleConfiguration.*;
import io.art.metrics.configurator.*;
...
import static io.art.metrics.configurator.PrometheusRegistryConfigurator.*;
import static io.art.metrics.configurator.PrometheusRegistryConfigurator.prometheusRegistryForApplication;
import static io.art.metrics.factory.DropwizardMetricRegistryFactory.createDefaultDropwizardMetricRegistry;
import java.util.*;
