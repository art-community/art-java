...
import io.art.kafka.consumer.configuration.KafkaConsumerConfiguration;
import io.art.kafka.consumer.configuration.KafkaConsumerModuleConfiguration.KafkaConsumerModuleDefaultConfiguration;
import io.art.kafka.consumer.configuration.KafkaStreamConfiguration;
...
import static io.art.config.extensions.common.CommonConfigKeys.ENABLE_TRACING;
import static io.art.config.extensions.common.CommonConfigKeys.THREAD_POOL_SIZE;
...
import static io.art.kafka.consumer.configuration.KafkaStreamConfiguration.streamConfiguration;
import static io.art.kafka.consumer.constants.KafkaConsumerModuleConstants.KAFKA_CONSUMER_MODULE_ID;
import static io.art.kafka.consumer.controller.KafkaConsumerController.restartKafkaConsumer;
import static io.art.kafka.consumer.module.KafkaConsumerModule.kafkaConsumerModuleState;
