package ru.adk.example.service;
...
import static ru.adk.entity.constants.ValueType.PrimitiveType.INT;
...
import static ru.adk.example.api.constants.ExampleApiConstants.Methods.REQUEST_RESPONSE_HANDLING_EXAMPLE;
import static ru.adk.example.dao.TableDualDao.testQuery;
import static ru.adk.example.factory.ExampleRequestFactory.getExampleRequest;
import static ru.adk.example.module.ExampleModule.exampleModule;
...
import static ru.adk.json.module.JsonModule.jsonModule;
...
import static ru.adk.task.deferred.executor.IdentifiedRunnableFactory.uniqueTask;
