...
import static ru.adk.http.client.body.descriptor.HttpBodyDescriptor.readResponseBody;
import static ru.adk.http.client.builder.HttpUriBuilder.buildUri;
import static ru.adk.http.client.constants.HttpClientExceptionMessages.REQUEST_CONTENT_TYPE_NOT_SUPPORTED;
import static ru.adk.http.client.constants.HttpClientExceptionMessages.RESPONSE_CONTENT_TYPE_NOT_SUPPORTED;
